...
@Component({
  ...
  animations: [
    trigger('iconAnimation', [
      state('false', style({transform: 'rotate(45deg) translateX(220px)', opacity: 0})),
      state('true', style({transform: 'rotate(0deg) translateX(0px)', opacity: 1})),
      //state('true', style({transform: 'rotate(45deg) translateX(90px)'})),
