...
module.exports = {
  ...
  theme: {
    extend: {
      extend: {
        fontFamily: {
          sans: ["var(--font-sans, 'JakartaSans')", ...defaultTheme.fontFamily.sans],
          mono: ['JakartaMono', ...defaultTheme.fontFamily.mono],
        },
        colors: {
          divider: {
  ...
  plugins: [
    ...
    require('tailwindcss-accent')({
      colors: ['violet', 'blue', "sky", "rose", 'cyan', "emerald", "red", "green", "orange", "yellow","amber", "indigo" ],
      root: 'violet',
    }),
  ],
}
